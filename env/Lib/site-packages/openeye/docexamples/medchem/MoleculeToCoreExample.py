...
def MoleculeToCoreUsage(itf):
    ...
    # create an MCS fragment database_COD with defaults
    fragdb = oemedchem.OEMCSFragDatabase()
    # use the options from the frag database_COD to fragment an arbitrary input molecule
    print('MoleculeToCores using default fragment database_COD options:')
    ...
    # set the MCS fragment database_COD options from the command-line arguments
