...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-DEFAULT>
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-COLORSTOPLABELFONT>
opts = oegrapheme.OEColorGradientDisplayOptions()
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-COLORSTOPLABELFONTSCALE>
opts = oegrapheme.OEColorGradientDisplayOptions()
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-COLORSTOPPRECISION>
opts = oegrapheme.OEColorGradientDisplayOptions()
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-COLORSTOPVISIBILITY>
opts = oegrapheme.OEColorGradientDisplayOptions()
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-BOXRANGE>
opts = oegrapheme.OEColorGradientDisplayOptions()
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-BOXRANGEPEN>
opts = oegrapheme.OEColorGradientDisplayOptions()
opts.SetBoxRange(-0.5, 0.5)
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-ADDMARKEDVALUE>
opts = oegrapheme.OEColorGradientDisplayOptions()
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-ADDMARKEDVALUES>
opts = oegrapheme.OEColorGradientDisplayOptions()
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-SETMARKEDVALUES>
opts = oegrapheme.OEColorGradientDisplayOptions()
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-MARKEDVALUEPRECISION>
opts = oegrapheme.OEColorGradientDisplayOptions()
markedvalues = oechem.OEDoubleVector([0.20, 0.70, 0.72])
opts.AddMarkedValues(markedvalues)
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-MARKEDVALUEPEN>
opts = oegrapheme.OEColorGradientDisplayOptions()
markedvalues = oechem.OEDoubleVector([0.20, 0.70, 0.72])
opts.AddMarkedValues(markedvalues)
...
# @ <SNIPPET-OECOLORGRADIENTDISPLAYOPTIONS-ADDLABEL>
opts = oegrapheme.OEColorGradientDisplayOptions()
