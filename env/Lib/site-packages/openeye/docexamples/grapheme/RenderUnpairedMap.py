...
# @ </SNIPPET-RENDER-UNPAIREDMAP>
oedepict.OEWriteImage("RenderUnpairedMap.png", image)
oedepict.OEWriteImage("RenderUnpairedMap.pdf", image)

# @ <SNIPPET-DRAW-UNPAIREDMAP-LEGEND>
# initailize OE2DActiveSiteDisplay

cgimage = oedepict.OEImage(400.0, 200.0)
lopts = oegrapheme.OE2DActiveSiteLegendDisplayOptions(3, 2)
oegrapheme.OEDrawUnpairedInteractionMapLegend(cgimage, adisp, lopts)
oedepict.OEWriteImage("DrawUnpairedMapLegend.png", cgimage)
# @ </SNIPPET-DRAW-UNPAIREDMAP-LEGEND>
oedepict.OEWriteImage("DrawUnpairedMapLegend.pdf", cgimage)
