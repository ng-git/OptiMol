...
# @ <SNIPPET-OEHIGHLIGHTBYCOGWHEEL-SETSTICKWIDTHSCALE>
highlight = oedepict.OEHighlightByCogwheel(oechem.OEDarkPurple)
...
# @ <SNIPPET-OEHIGHLIGHTBYCOGWHEEL-SETBALLRADIUSSCALE>
highlight = oedepict.OEHighlightByCogwheel(oechem.OEDarkPurple)
