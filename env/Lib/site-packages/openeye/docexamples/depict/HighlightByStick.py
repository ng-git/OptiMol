...
# @ <SNIPPET-OEHIGHLIGHTBYSTICK-SETATOMLABELMONOCHROME>
highlight = oedepict.OEHighlightByStick(oechem.OELightOrange)
...
# @ <SNIPPET-OEHIGHLIGHTBYSTICK-SETATOMEXTERNALHIGHLIGHTRATIO>
highlight = oedepict.OEHighlightByStick(oechem.OELightOrange)
