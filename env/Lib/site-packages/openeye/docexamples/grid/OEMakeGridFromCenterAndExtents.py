...
# @ <SNIPPET-OEMakeGridFromCenterAndExtents>
...
print("Mid: %.6f %.6f %.6f" % (grid.GetXMid(), grid.GetYMid(), grid.GetZMid()))
print("Dim: %d %d %d" % (grid.GetXDim(), grid.GetYDim(), grid.GetZDim()))
print("Spacing: %.6f" % grid.GetSpacing())
# @ </SNIPPET>
