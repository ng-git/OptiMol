...
# about this warning.
"""
 Test suite for Quacpac TK examples
"""
...
@pytest.mark.skipif(check_license('quacpac') is False, reason='QUACPAC license not found')
class TestQuacpac(OETestCase):

    def test_example3(self):
        script = self.run_example(
            '{0}/quacpac/enumeratetautomers.py'.format(self.EXAMPLES_DIR),
