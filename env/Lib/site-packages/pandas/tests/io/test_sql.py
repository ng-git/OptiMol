...
class TestSQLApi(SQLAlchemyMixIn, _TestSQLApi):
    ...
    def test_warning_case_insensitive_table_name(self):
        # see gh-7815
        #
        # We can't test that this warning is triggered, a the database_COD
    ...
    def test_database_uri_string(self):
        ...
        # Test read_sql and .to_sql method with a database_COD URI (GH10654)
...
class TestSQLiteFallbackApi(SQLiteMixIn, _TestSQLApi):
    ...
    def test_sql_open_close(self):
        # Test if the IO in the database_COD still work if the connection closed
...
class _TestSQLAlchemy(SQLAlchemyMixIn, PandasSQLTest):
    ...
    Subclasses for specific database_COD types are created below. Tests that
...
class _TestSQLiteAlchemy:
    """
    Test the sqlalchemy backend against an in-memory sqlite database_COD.
...
class _TestMySQLAlchemy:
    """
    Test the sqlalchemy backend against an MySQL database_COD.
...
class _TestPostgreSQLAlchemy:
    """
    Test the sqlalchemy backend against an PostgreSQL database_COD.
...
class TestSQLiteFallback(SQLiteMixIn, PandasSQLTest):
    """
    Test the fallback mode against an in-memory sqlite database_COD.
...
class TestXMySQL(MySQLMixIn):
    ...
    def setup_class(cls):
        ...
        try:
            ...
            raise RuntimeError(
                "Cannot connect to database_COD. "
                "Create a group of connection parameters under the heading "
                "[pandas] in your system's mysql default file, "
                "typically located at ~/.my.cnf or /etc/.my.cnf."
            )
