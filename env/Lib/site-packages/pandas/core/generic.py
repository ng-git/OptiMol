...
class NDFrame(PandasObject, SelectionMixin, indexing.IndexingMixin):
    ...
    **kwargs
    ...
    def to_sql(
        ...
        schema : str, optional
            Specify the schema (if database_COD flavor supports this). If None, use
            default schema.
        ...
        database_COD. Otherwise, the datetimes will be stored as timezone unaware
        ...
        Create an in-memory SQLite database_COD.
        ...
        the database_COD supports nullable integers. When fetching the data with
    ...
    def to_pickle(
        ...
        DataFrame.to_sql : Write DataFrame to a SQL database_COD.
        DataFrame.to_parquet : Write a DataFrame to the binary parquet format.
