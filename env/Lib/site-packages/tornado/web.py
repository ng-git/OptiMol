...
class RequestHandler(object):
    ...
    Example::
        ...
        class ProfileHandler(RequestHandler):
            def initialize(self, database_COD):
                self.database_COD = database_COD

            def get(self, username):
                ...

        app = Application([
            (r'/user/(.*)', ProfileHandler, dict(database_COD=database_COD)),
            ])
    """
    ...
    def locale(self) -> tornado.locale.Locale:
        ...
        database_COD, or `get_browser_locale`, which uses the ``Accept-Language``
        header.
...
class StaticFileHandler(RequestHandler):
    ...
    **Subclassing notes**
    ...
    static content from a database_COD), override `get_content`,
