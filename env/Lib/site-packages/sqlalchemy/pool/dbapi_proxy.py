...
def manage(module, **params):
    ...
    :param module: a DB-API 2.0 database_COD module
...
class _DBProxy(object):
    ...
    def connect(self, *args, **kw):
        """Activate a connection to the database_COD.

        Connect to the database_COD using this DBProxy's module and the given
        ...
        to be created, a new database_COD connection will be made.
