...
class DDLEvents(event.Events):
    ...
    DDL is emitted to the database_COD.
...
class PoolEvents(event.Events):
    ...
    def first_connect(self, dbapi_connection, connection_record):
        ...
        information about a particular series of database_COD connections based
        ...
        connections, such as the database_COD version, the server and client
...
class ConnectionEvents(event.Events):
    ...
    to the database_COD.  The :meth:`.before_cursor_execute` event is
    ...
    def before_execute(self, conn, clauseelement, multiparams, params):
        ...
        as early manipulation of the parameters being sent to the database_COD,
    ...
    def engine_connect(self, conn, branch):
        ...
        refers to the actual connection to a database_COD at the DBAPI level;
