...
def column_mapped_collection(mapping_spec):
    ...
    change during the session, i.e. from None to a database_COD-assigned integer
...
class collection(object):
    ...
    def appender(fn):
        ...
        will be called for each object mapped by a database_COD query.  If the
        database_COD contains rows that violate your collection semantics, you
...
class MappedCollection(dict):
    ...
    def __init__(self, keyfunc):
        ...
        value-only (such as when loading instances from the database_COD) or
