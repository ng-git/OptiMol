...
configurational unit which associates a class with a database_COD table.
...
class Mapper(InspectionAttr):
    """Define the correlation of class attributes to database_COD table
    columns.
    ...
    def __init__(
        ...
        :param always_refresh: If True, all query operations for this mapped
           ...
           whatever information was loaded from the database_COD. Usage of this
           flag is highly discouraged; as an alternative, see the method
           :meth:`.Query.populate_existing`.

        :param allow_partial_pks: Defaults to True.  Indicates that a
           composite primary key with some NULL values should be considered as
           possibly existing within the database_COD. This affects whether a
           mapper will assign an incoming row to an existing identity, as well
           as if :meth:`.Session.merge` will check the database_COD first for a
        ...
        :param confirm_deleted_rows: defaults to True; when a DELETE occurs
          ...
          case where database_COD ON DELETE CASCADE rules may be deleting some of
        ...
        :param eager_defaults: if True, the ORM will immediately fetch the
          ...
          target database_COD supports :term:`RETURNING`, the default values will
        ...
        :param passive_updates: Indicates UPDATE behavior of foreign key
           ...
           the foreign key in the database_COD, and that the database_COD will handle
           propagation of an UPDATE from a source column to dependent columns
           on joined-table rows.

           When False, it is assumed that the database_COD does not enforce
        ...
        :param polymorphic_on: Specifies the column, attribute, or
          ...
          of the discriminator should be persisted to the database_COD,
          the value of the
    ...
    def identity_key_from_instance(self, instance):
        ...
        will result in a database_COD check to see if the object has been deleted.
...
def reconstructor(fn):
    ...
    loaded from the database_COD or otherwise reconstituted.

    The reconstructor will be invoked with no arguments.  Scalar
    (non-collection) database_COD-mapped attributes of the instance will
