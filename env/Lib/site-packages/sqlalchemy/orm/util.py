...
def identity_key(*args, **kwargs):
    ...
    * ``identity_key(instance=instance)``
      ...
      effect of performing a database_COD check for the corresponding row
    ...
    * ``identity_key(class, row=row, identity_token=token)``
      ...
      database_COD result row as a :class:`.RowProxy` object.
...
def has_identity(object_):
    """Return True if the given object has a database_COD
    identity.
