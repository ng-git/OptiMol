...
construct used by the ORM to construct database_COD queries.

The :class:`.Query` class should not be confused with the
:class:`.Select` class, which defines database_COD
SELECT operations at the SQL (non-ORM) level.  ``Query`` differs from
``Select`` in that it returns ORM-mapped objects and interacts with an
ORM session, whereas the ``Select`` construct interacts directly with the
database_COD to return iterable result sets.
...
class Query(object):
    ...
    def yield_per(self, count):
        ...
        eager loading, **provided the database_COD driver supports multiple,
        ...
        .. warning::
            ...
            available.  The memory use of raw database_COD rows is much less
    ...
    def get(self, ident):
        ...
        before querying the database_COD.  See :doc:`/orm/loading_relationships`
    ...
    def with_hint(self, selectable, text, dialect_name="*"):
        ...
        .. seealso::
            ...
            can suit some database_COD-specific HINT syntaxes such as MySQL
            optimizer hints
    ...
    def union(self, *q):
        ...
        Note that many database_COD backends do not allow ORDER BY to
    ...
    def distinct(self, *expr):
        ...
        .. note::
            ...
            of the database_COD backend that ORDER BY columns be part of the
    ...
    def delete(self, synchronize_session="evaluate"):
        ...
        Deletes rows matched by this query from the database_COD.
        ...
        :param synchronize_session: chooses the strategy for the removal of
            ...
            string collations between the database_COD and Python.

        :return: the count of rows matched as returned by the database_COD's
          "row count" feature.
        ...
        .. warning:: **Additional Caveats for bulk query deletes**
            ...
            * This method does **not work for joined
              ...
              **join condition of an inheritance mapper is not
              ...
              unless an ON DELETE CASCADE rule is established in the database_COD
              to handle it.
            ...
            * The method does **not** offer in-Python cascading of
              ...
              which require it, otherwise the database_COD may emit an
    ...
    def update(self, values, synchronize_session="evaluate", update_args=None):
        ...
        Updates rows matched by this query in the database_COD.
        ...
        .. warning:: **Additional Caveats for bulk query updates**
            ...
            * The method does **not** offer in-Python cascading of
              ...
              it, otherwise the database_COD may emit an integrity
