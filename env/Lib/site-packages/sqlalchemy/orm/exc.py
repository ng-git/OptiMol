...
class StaleDataError(sa_exc.SQLAlchemyError):
    """An operation encountered database_COD state that is unaccounted for.
    ...
    * A mapped object with version_id_col was refreshed,
      and the version number coming back from the database_COD does
...
class ObjectDeletedError(sa_exc.InvalidRequestError):
    """A refresh operation failed to retrieve the database_COD
...
class NoResultFound(sa_exc.InvalidRequestError):
    """A database_COD result was required but none was found."""


class MultipleResultsFound(sa_exc.InvalidRequestError):
    """A single database_COD result was required but more than one were found."""
