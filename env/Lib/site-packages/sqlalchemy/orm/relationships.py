...
class RelationshipProperty(StrategizedProperty):
    ...
    of items that correspond to a related database_COD table.
    ...
    def __init__(
        ...
        :param foreign_keys:
          ...
          :paramref:`~.relationship.foreign_keys` is only needed when:
            ...
            2. The :class:`.Table` being mapped does not actually have
               ...
               was reflected from a database_COD that does not support foreign key
        ...
        :param passive_deletes=False:
           ...
           scenario is in place on the database_COD side.  Note that the foreign
        ...
        :param passive_updates=True:
          ...
          the foreign key in the database_COD, and that the database_COD will
          ...
          the database_COD is in fact enforcing referential integrity, unless
          ...
          and instead uses the referential integrity features of the database_COD
