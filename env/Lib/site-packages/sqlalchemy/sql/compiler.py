...
class Compiled(object):
    ...
    specific to their underlying database_COD dialect, and also may
...
class SQLCompiler(Compiled):
    ...
    def render_literal_value(self, value, type_):
        ...
        on the target driver/database_COD.
    ...
    def visit_insert(self, insert_stmt, asfrom=False, **kw):
        ...
        if (
            ...
            raise exc.CompileError(
                "The '%s' dialect with current database_COD "
...
class IdentifierPreparer(object):
    ...
    def _escape_identifier(self, value):
        ...
        Subclasses should override this to provide database_COD-dependent
        escaping behavior.
        """
    ...
    def quote_schema(self, schema, force=None):
        ...
        Subclasses can override this to provide database_COD-dependent
    ...
    def format_table_seq(self, table, use_schema=True):
        ...
        # ('database_COD', 'owner', etc.) could override this and return
        # a longer sequence.
