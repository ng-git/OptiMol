...
class DDLElement(Executable, _DDLCompiles):
    ...
    def execute_if(self, dialect=None, callable_=None, state=None):
        ...
        :param dialect: May be a string, tuple or a callable
          ...
          executing database_COD dialect::
    ...
    def _check_ddl_on(self, on):
        if on is not None and (
            ...
            raise exc.ArgumentError(
                "Expected the name of a database_COD dialect, a tuple "
...
class DDL(DDLElement):
    ...
    Specifies literal SQL DDL to be executed by the database_COD.  DDL objects
...
class DropTableComment(_CreateDropBase):
    ...
    Note this varies a lot across database_COD backends.
