...
class ColumnOperators(Operators):
    ...
    def __getitem__(self, index):
        ...
        This can be used by some database_COD-specific types
    ...
    def in_(self, other):
        ...
        * A bound parameter, e.g. :func:`.bindparam`, may be used if it
          ...
          The database_COD would be passed a bound parameter for each value::
          ...
          which is specific to the database_COD in use, is rendered.  On
    ...
    def startswith(self, other, **kwargs):
        ...
        :param escape: a character which when given will render with the
          ...
          ``"foo^%bar^^bat"`` before being passed to the database_COD.
    ...
    def match(self, other, **kwargs):
        """Implements a database_COD-specific 'match' operator.
