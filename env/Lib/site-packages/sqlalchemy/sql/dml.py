...
class UpdateBase(
    ...
    def returning(self, *cols):
        ...
        Upon compilation, a RETURNING clause, or database_COD equivalent,
        ...
        read the documentation notes for the database_COD in use in
    ...
    def with_hint(self, text, selectable=None, dialect_name="*"):
        ...
        location for the database_COD backend in use, relative
...
class ValuesBase(UpdateBase):
    ...
    def values(self, *args, **kwargs):
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         method, which is supported by all database_COD backends and is generally
...
class Insert(ValuesBase):
    ...
    def from_select(self, names, select, include_defaults=True):
        ...
        :param select: a :func:`.select` construct, :class:`.FromClause`
         ...
         is not checked before passing along to the database_COD, the database_COD
...
class Update(ValuesBase):
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        :param table: A :class:`.Table` object representing the database_COD
         table to be updated.
