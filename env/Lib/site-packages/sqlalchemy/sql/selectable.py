...
class GenerativeSelect(SelectBase):
    ...
    def with_for_update(
        ...
        On a database_COD like PostgreSQL or Oracle, the above would render a
        statement like::
        ...
        provided which allow for common database_COD-specific
        variants.
...
class Select(HasPrefixes, HasSuffixes, GenerativeSelect):
    ...
    def with_statement_hint(self, text, dialect_name="*"):
        ...
        Hints here are specific to the backend database_COD and may include
