...
class TypeEngine(Visitable):
    ...
    class Comparator(operators.ColumnOperators):
        ...
        def _adapt_expression(self, op, other_comparator):
            ...
            "days delta" behavior by the database_COD (in reality, most databases
    ...
    def compare_against_backend(self, dialect, conn_type):
        ...
        given type; the type is typically reflected from the database_COD
        so should be database_COD specific.  The dialect in use is also
    ...
    def column_expression(self, colexpr):
        ...
        columns to be wrapped in some special database_COD function in order
    ...
    def bind_expression(self, bindvalue):
        ...
        that require literals being wrapped in some special database_COD function
        in order to coerce an application-level value into a database_COD-specific
...
class Emulated(object):
    ...
    An :class:`.Emulated` type will use an available database_COD type
    in conjunction with Python-side routines and/or database_COD constraints
    in order to approximate the behavior of a database_COD type that is provided
...
class TypeDecorator(SchemaEventTarget, TypeEngine):
    ...
    def literal_processor(self, dialect):
        ...
        database_COD presentation.  With the value converted by
        ...
        parameter or to the database_COD as an inline SQL value.
...
def adapt_type(typeobj, colspecs):
    ...
    for t in typeobj.__class__.__mro__[0:-1]:
        ...
        return typeobj
    # if we adapted the given generic type to a database_COD-specific type,
