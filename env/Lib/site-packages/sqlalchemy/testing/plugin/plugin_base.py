...
def setup_options(make_option):
    ...
    make_option(
        ...
        type="string",
        dest="db",
        help="Use prefab database_COD uri. Multiple OK, "
    ...
    make_option(
        ...
        action="store_true",
        dest="dropfirst",
        help="Drop all tables in the target database_COD first",
    )
    make_option(
        "--backend-only",
        action="store_true",
    ...
    make_option(
        ...
        type="string",
        help="name of template database_COD to use for PostgreSQL "
        "CREATE DATABASE (defaults to current database_COD)",
    )
    make_option(
        "--low-connections",
        action="store_true",
