...
collection, and not the initial load from the database_COD, and requires that the
...
class OrderingList(list):
    ...
    def __init__(
        ...
        :param reorder_on_append:
          ...
          variety of dangerous unexpected database_COD writes.

          SQLAlchemy will add instances to the list via append() when your
          object loads.  If for some reason the result set from the database_COD
