...
"""Provides an abstraction for obtaining database_COD schema information.
...
class Inspector(object):
    """Performs database_COD schema inspection.
    ...
    methods specific to the dialect's target database_COD.
    ...
    def default_schema_name(self):
        ...
        for the current engine's database_COD user.
    ...
    def get_table_names(self, schema=None, order_by=None):
        ...
        :param schema: Schema name. If ``schema`` is left at ``None``, the
         database_COD's default schema is
         used, else the named schema is searched.  If the database_COD does not
    ...
    def get_table_options(self, table_name, schema=None, **kw):
        ...
        :param schema: string schema name; if omitted, uses the default schema
         of the database_COD connection.  For special quoting,
         use :class:`.quoted_name`.
