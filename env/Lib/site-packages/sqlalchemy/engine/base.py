...
class Connection(Connectable):
    ...
    def execution_options(self, **opt):
        ...
        :param isolation_level: Available on: :class:`.Connection`.
          ...
          semi-database_COD specific; see individual dialect documentation for
          valid levels.
          ...
          .. warning::  The ``isolation_level`` execution option should
             **not** be used when a transaction is already established, that
             ...
             called.  A database_COD cannot change the isolation level on a
    ...
    def begin_nested(self):
        ...
        underlying database_COD.  Any transaction in the hierarchy may
    ...
    def close(self):
        ...
        This results in a release of the underlying database_COD
...
class Transaction(object):
    """Represent a database_COD transaction in progress.
...
class Engine(Connectable, log.Identified):
    ...
    source of database_COD connectivity and behavior.
    ...
    def execution_options(self, **opt):
        ...
        * The logging configuration and logging_name is copied from the parent
        ...
        time keeping track of which database_COD we've established using the
    ...
    def dispose(self):
        ...
        database_COD connections.  Connections that are still checked out
        ...
        does not make any actual connections to the database_COD until one is
    ...
    def connect(self, **kwargs):
        ...
        connection internally in order to communicate with the database_COD.  This
    ...
    def table_names(self, schema=None, connection=None):
        """Return a list of all table names available in the database_COD.
