...
to database_COD dialect authors; dialects will usually use the classes here
...
class DefaultDialect(interfaces.Dialect):
    ...
    def type_descriptor(self, typeobj):
        """Provide a database_COD-specific :class:`.TypeEngine` object, given
