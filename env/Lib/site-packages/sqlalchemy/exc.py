...
class NoSuchModuleError(ArgumentError):
    """Raised when a dynamically-loaded module (usually a database_COD dialect)
...
class InvalidatePoolError(DisconnectionError):
    ...
    entire pool should be invalidated, as the database_COD has been restarted.
...
class UnboundExecutionError(InvalidRequestError):
    """SQL was attempted without a database_COD connection to execute it on."""
...
class DBAPIError(StatementError):
    """Raised when the execution of a database_COD operation fails.

    Wraps exceptions raised by the DB-API underlying the
    database_COD operation.  Driver-specific implementations of the standard
