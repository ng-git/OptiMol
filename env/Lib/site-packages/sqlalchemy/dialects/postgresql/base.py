...
Will generate on the backing database_COD as::
...
the actual name of the column as expressed in the database_COD.
...
When using CONCURRENTLY, the PostgreSQL database_COD requires that the statement
...
The PostgreSQL database_COD creates a UNIQUE INDEX implicitly whenever the
...
class ENUM(sqltypes.NativeForEmulated, sqltypes.Enum):
    ...
    def __init__(self, *enums, **kw):
        ...
        :param create_type: Defaults to True.
         ...
         without access to the actual database_COD -
