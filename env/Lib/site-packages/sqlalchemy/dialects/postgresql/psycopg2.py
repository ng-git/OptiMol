...
PostgreSQL database_COD that is open for "trust" connections.  This behavior can be
...
Typically, this can be changed to ``utf8``, as a more useful default::
    ...
    # client_encoding = sql_ascii # actually, defaults to database_COD
                                 # encoding
...
it is detected that the target database_COD has the HSTORE type set up for use.
