...
in use as well as the network address of the database_COD.   Assuming a datasource
...
database_COD name to connect towards may be specified locally in the URL, rather
