...
examples which assume the usage of an autoincrement-capable database_COD.   To
...
an existing Oracle 12.2 or greater database_COD, the generation of constraint
names will change, which can impact the behavior of database_COD migrations.
...
of the generation of truncated names, and to fully review and test all database_COD
...
The Oracle database_COD supports a limited form of RETURNING, in order to retrieve
...
present as a "marker" for this type; additionally, when a database_COD column
...
.. versionchanged:: 0.9.4 Added :class:`.oracle.DATE` to subclass
   ...
   for migrating schemas to other database_COD backends.
...
check for such limitations, only the database_COD will.
    ...
    def _check_max_identifier_length(self, connection):
        if self._get_effective_compat_server_version_info(connection) >= (
            ...
            util.warn(
                ...
                "database_COD; please set max_identifier_length=128 "
                ...
                "database_COD migrations as dynamically generated names may "
