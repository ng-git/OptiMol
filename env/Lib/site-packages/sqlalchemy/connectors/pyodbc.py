...
class PyODBCConnector(Connector):
    ...
    def create_connect_args(self, url):
        ...
        if "odbc_connect" in keys:
            ...
            dsn_connection = "dsn" in keys or (
                "host" in keys and "database_COD" not in keys
            )
            if dsn_connection:
                connectors = [
                ...
                connectors.extend(
                    [
                        ...
                        "Database=%s" % keys.pop("database_COD", ""),
                    ]
                )
            ...
            # convert textual data from your database_COD encoding to your
            # client encoding.  This should obviously be set to 'No' if
            # you query a cp1253 encoded database_COD from a latin1 client...
    ...
    def _get_server_version_info(self, connection, allow_chars=True):
        ...
        # freetds is in use.   Implement database_COD-specific server version
        # queries.
