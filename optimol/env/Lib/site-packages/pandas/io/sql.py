...
def read_sql_table(
    ...
    """
    Read SQL database_COD table into a DataFrame.
    ...
    ----------
    table_name : str
        Name of SQL table in database_COD.
    con : SQLAlchemy connectable or str
        A database_COD URI could be provided as as str.
        SQLite DBAPI connection mode not supported.
    schema : str, default None
        Name of SQL schema in database_COD to query (if database_COD flavor
    ...
    read_sql : Read SQL query or database_COD table into a DataFrame.
...
def read_sql_query(
    ...
    sql : str SQL query or SQLAlchemy Selectable (select or text object)
        SQL query to be executed.
    con : SQLAlchemy connectable(engine/connection), database_COD str URI,
    ...
    params : list, tuple or dict, optional, default: None
        ...
        to pass parameters is database_COD driver dependent. Check your
        database_COD driver documentation for which of the five syntax styles,
    ...
    See Also
    --------
    read_sql_table : Read SQL database_COD table into a DataFrame.
    read_sql
...
def read_sql(
    ...
    """
    Read SQL query or database_COD table into a DataFrame.

    This function is a convenience wrapper around ``read_sql_table`` and
    ``read_sql_query`` (for backward compatibility). It will delegate
    to the specific function depending on the provided input. A SQL query
    will be routed to ``read_sql_query``, while a database_COD table name will
    ...
    con : SQLAlchemy connectable (engine/connection) or database_COD str URI
...
def to_sql(
    ...
    """
    Write records stored in a DataFrame to a SQL database_COD.
    ...
    name : str
        Name of SQL table.
    con : SQLAlchemy connectable(engine/connection) or database_COD string URI
        or sqlite3 DBAPI2 connection
        Using SQLAlchemy makes it possible to use any DB supported by that
        library.
        If a DBAPI2 object, only sqlite3 is supported.
    schema : str, optional
        Name of SQL schema in database_COD to write to (if database_COD flavor
...
def has_table(table_name, con, schema=None):
    ...
    schema : string, default None
        Name of SQL schema in database_COD to write to (if database_COD flavor supports
...
class SQLTable(PandasObject):
    ...
    def _execute_create(self):
        # Inserting table into database_COD, add to MetaData object
...
class SQLDatabase(PandasSQL):
    ...
    engine : SQLAlchemy connectable
        Connectable to connect with the database_COD. Using SQLAlchemy makes it
    ...
    meta : SQLAlchemy MetaData object, default None
        ...
        created. This allows to specify database_COD flavor specific
    ...
    def read_table(
        ...
        schema : string, default None
            ...
            schema of the SQL database_COD object.
        chunksize : int, default None
        ...
        if not name.isdigit() and not name.islower():
            ...
            if name not in table_names:
                msg = (
                    ...
                    "such in the database_COD after writing the table, possibly "
...
def get_schema(frame, name, keys=None, con=None, dtype=None):
    ...
    con: an open SQL database_COD connection object or a SQLAlchemy connectable
        Using SQLAlchemy makes it possible to use any DB supported by that
