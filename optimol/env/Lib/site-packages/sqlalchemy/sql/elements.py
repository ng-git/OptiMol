...
class BindParameter(ColumnElement):
    ...
    def __init__(
        ...
        Above, we see that ``Wendy`` is passed as a parameter to the database_COD,
        while the placeholder ``:name_1`` is rendered in the appropriate form
        for the target database_COD, in this case the PostgreSQL database_COD.
        ...
        :param type\_:
          ...
          passed to the database_COD.  For example, a :func:`.bindparam` which
...
class Cast(ColumnElement):
    ...
    def __init__(self, expression, type_):
        ...
        .. versionchanged:: 0.9.0 :func:`.cast` now applies the given type
           ...
           e.g. the Python-to-database_COD direction, in addition to the
           result handling, e.g. database_COD-to-Python, direction.
...
class BinaryExpression(ColumnElement):
    ...
    """Indicates that any database_COD will know this is a boolean expression
    even if the database_COD does not have an explicit boolean datatype.
...
class Over(ColumnElement):
    ...
    itself.  It's supported only by certain database_COD
    backends.
    ...
    def __init__(
        ...
        for database_COD backends that support window functions.
...
class WithinGroup(ColumnElement):
    ...
    It's supported only by certain database_COD backends, such as PostgreSQL,
...
class FunctionFilter(ColumnElement):
    ...
    It's supported only by certain database_COD backends.
    ...
    def __init__(self, func, *criterion):
        ...
        for database_COD backends that support the "FILTER" clause.
...
class ColumnClause(Immutable, ColumnElement):
    ...
    def __init__(self, text, type_=None, is_literal=False, _selectable=None):
        ...
        like the name of a database_COD column; if the string contains mixed case,
...
class quoted_name(util.MemoizedSlots, util.text_type):
    ...
    "name normalize" option.  Certain database_COD backends, such as
