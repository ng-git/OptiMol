...
"""private module containing functions used to convert database_COD
...
def load_on_ident(
    ...
    """Load the given identity key from the database_COD."""
...
def load_on_pk_identity(
    ...
    """Load the given primary key identity from the database_COD."""
...
def _validate_version_id(mapper, state, dict_, row, adapter):
    ...
    if (
        ...
        raise orm_exc.StaleDataError(
            ...
            "does not match database_COD-loaded version id '%s'."
            % (
                state_str(state),
