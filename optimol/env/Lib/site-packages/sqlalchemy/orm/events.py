...
class InstanceEvents(event.Events):
    ...
    * the :class:`.Mapper` class itself and the :func:`.mapper`
    ...
    def init(self, target, args, kwargs):
        ...
        loaded from the database_COD; see the :meth:`.InstanceEvents.load`
        event in order to intercept a database_COD load.
...
class MapperEvents(event.Events):
    ...
    * the :class:`.Mapper` class itself and the :func:`.mapper`
    ...
    additional database_COD state during a flush.
    ...
    def before_insert(self, mapper, connection, target):
        ...
        :param connection: the :class:`.Connection` being used to
         ...
         target database_COD specific to this instance.
...
class SessionEvents(event.Events):
    ...
    def after_transaction_create(self, session, transaction):
        ...
        on individual database_COD connections.  It is also invoked
    ...
    def before_commit(self, session):
        ...
        .. note::
            ...
            that is, the :class:`.Session` can emit SQL to the database_COD
    ...
    def after_rollback(self, session):
        ...
        the database_COD occurs - it does *not* fire each time the
    ...
    def after_flush(self, session, flush_context):
        ...
        .. warning:: This event runs after the :class:`.Session` has emitted
           SQL to modify the database_COD, but **before** it has altered its
    ...
    def persistent_to_deleted(self, session, instance):
        ...
        is deleted from the database_COD within a flush, however the object
...
class AttributeEvents(event.Events):
    ...
    :param active_history=False: When True, indicates that the
      ...
      database_COD loads. Note that ``active_history`` can also be
    ...
    def set(self, target, value, oldvalue, initiator):
        ...
        :param oldvalue: the previous value being replaced.  This
          ...
          the database_COD if the existing value is currently unloaded
          or expired.
        :param initiator: An instance of :class:`.attributes.Event`
          representing the initiation of the event.  May be modified
          from its original value by backref handlers in order to control
    ...
    def init_scalar(self, target, value, dict_):
        ...
        * By setting the value ``SOME_CONSTANT`` in the given ``dict_``,
          we indicate that this value is to be persisted to the database_COD.
