...
class Dialect(object):
    """Define the behavior of a specific database_COD and DB-API combination.

    Any aspect of metadata definition, SQL query generation,
    execution, result-set handling, or anything else which varies
    between databases is defined under the general category of the
    Dialect.  The Dialect acts as a factory for other
    database_COD-specific object implementations including
    ...
    server_version_info
      ...
      typically populated during the initial connection to the database_COD.

    default_schema_name
     the name of the default schema.  This value is only available for
     supporting dialects, and is typically populated during the
     initial connection to the database_COD.
    ...
    supports_alter
      ``True`` if the database_COD supports ``ALTER TABLE``.
    ...
    def reflecttable(
        ...
        """Load table description from the database_COD.

        Given a :class:`.Connection` and a
        :class:`~sqlalchemy.schema.Table` object, reflect its columns and
        properties from the database_COD.
    ...
    def get_view_names(self, connection, schema=None, **kw):
        """Return a list of all view names available in the database_COD.
    ...
    def has_table(self, connection, table_name, schema=None):
        """Check the existence of a particular table in the database_COD.

        Given a :class:`.Connection` object and a string
        `table_name`, return True if the given table (possibly within
        the specified `schema`) exists in the database_COD, False
        otherwise.
        """
    ...
    def has_sequence(self, connection, sequence_name, schema=None):
        """Check the existence of a particular sequence in the database_COD.

        Given a :class:`.Connection` object and a string
        `sequence_name`, return True if the given sequence exists in
        the database_COD, False otherwise.
        """
...
class CreateEnginePlugin(object):
    ...
    names can be added to the database_COD URL.  Target applications for
    ...
    * connectivity plugins such as proxies
    ...
    A plugin that uses the above names would be invoked from a database_COD
    URL as in::
...
class ExecutionContext(object):
    ...
    def lastrow_has_defaults(self):
        ...
        inlined or database_COD-side defaults.
        """
